...
<div class="container container-fluid">
    <div class="col-md-7 mx-auto">
      ...
      <?php flash("register_success");?>
        <h2>Login into Postum</h2>
        <p>Please fill out this form to login in Postum.</p>
        <form action="<?php echo URLROOT; ?>/users/login" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col">
              <a href="<?php echo URLROOT; ?>/users/register" class="btn btn-info btn-block">No account? Register</a>
            </div>
          </div>
        </form>
      </div>
